...
contract ExclusiveCigarettes is ERC721A, Ownable, ReentrancyGuard {
...
// ================== Variables Start =======================
  ...
  uint256 public cost1 = 0.015 ether;
  uint256 public cost2 = 0.15 ether;
...
// ================== Constructor Start =======================
  ...
  constructor(
    string memory _uri
  ) ERC721A("ExclusiveCigarettes", "EC")  {
    seturi(_uri);
  }
